...
const navByRole: Record<Role, string[]> = { Student: ['Overview', 'Study tasks', 'Course catalog', 'My schedule', 'Grades'], Instructor: ['Overview', 'My courses', 'Students', 'Gradebook'], Administrator: ['Overview', 'Accounts', 'Courses', 'Analytics'] }
